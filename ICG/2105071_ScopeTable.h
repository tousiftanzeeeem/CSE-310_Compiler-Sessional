...
public:
    ...
    bool insert(string name,string type,string datatype,string vartype,bool is_global,int offset)    {
        int idx = calculate_index(name);
        if (table[idx] == nullptr) 
        {
            table[idx] = new Symbolinfo(name, type,datatype,vartype,is_global,offset);
        ...
        prev->setNext(new Symbolinfo(name, type,datatype,vartype,is_global,offset));
