...
public:
	...
	bool insert(string name,string type,string datatype,string vartype,bool is_global = false,int offset = 0){
        return currentscope->insert(name,type,datatype,vartype,is_global, offset);
	}
